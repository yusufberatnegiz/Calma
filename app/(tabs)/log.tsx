...
export default function LogScreen() {
  ...
  const { logs, dispatch: logDispatch } = useLogs();
  ...
  // Load today's existing log once (after store hydrates from AsyncStorage)
  ...
  useEffect(() => {
    ...
    if (todayLog !== undefined) {
      ...
      if (todayLog.dayRating !== undefined) setDayRating(todayLog.dayRating);
      if (todayLog.compulsionCount !== undefined)
        setCompulsionCount(todayLog.compulsionCount);
      if (todayLog.selectedTypes !== undefined)
        setSelectedTypes(todayLog.selectedTypes);
  ...
  const handleSave = () => {
    const isFirstSaveToday = logs[today] === undefined;
          ...
          <View style={styles.section}>
            ...
            <View style={styles.countRow}>
              <Pressable
                ...
                onPress={() =>
                  setCompulsionCount(Math.max(0, compulsionCount - 1))
                }
              >
